...
if __name__ == '__main__':
    ...
    for i in range(len(file_name)):
        try:
            ...
            outResult('SEMIFS_MM', file_name[i], selected_num[i], step[i], 's', 'KNN')
            outResult('CHI', file_name[i], selected_num[i], step[i], 's', 'KNN')
            outResult('f_score', file_name[i], selected_num[i], step[i], 's', 'KNN')
            outResult('fisher', file_name[i], selected_num[i], step[i], 's', 'KNN')
            outResult('IG', file_name[i], selected_num[i], step[i], 's', 'KNN')
            outResult('MCFS', file_name[i], selected_num[i], step[i], 's', 'KNN')
            outResult('reliefF', file_name[i], selected_num[i], step[i], 's', 'KNN')
            outResult('SPEC', file_name[i], selected_num[i], step[i], 's', 'KNN')
        except:
    ...
    #     try:
    #         print('---------**** runing : ', '第 ', i + 1, ' 个数据集 *******---------')
    #         outResult('SEMIFS_MM',file_name[i], selected_num[i], step[i], 'o', 'KNN')
    #         outResult('CHI', file_name[i], selected_num[i], step[i], 'o', 'KNN')
    #         outResult('f_score', file_name[i], selected_num[i], step[i], 'o', 'KNN')
    #         outResult('fisher', file_name[i], selected_num[i], step[i], 'o', 'KNN')
    #         outResult('IG', file_name[i], selected_num[i], step[i], 'o', 'KNN')
    #         outResult('MCFS', file_name[i], selected_num[i], step[i], 'o', 'KNN')
    #         outResult('reliefF', file_name[i], selected_num[i], step[i], 'o', 'KNN')
    #         outResult('SPEC', file_name[i], selected_num[i], step[i], 'o', 'KNN')
    #     except:
    #         print('this dataset arise error')
    #         continue
    #
    ...
    #     try:
    #         print('---------**** runing : ', '第 ', i + 1, ' 个数据集 *******---------')
    #         outResult('SEMIFS_MM',file_name[i], selected_num[i], step[i], 'm', 'KNN')
    #         outResult('CHI', file_name[i], selected_num[i], step[i], 'm', 'KNN')
    #         outResult('f_score', file_name[i], selected_num[i], step[i], 'm', 'KNN')
    #         outResult('fisher', file_name[i], selected_num[i], step[i], 'm', 'KNN')
    #         outResult('IG', file_name[i], selected_num[i], step[i], 'm', 'KNN')
    #         outResult('MCFS', file_name[i], selected_num[i], step[i], 'm', 'KNN')
    #         outResult('reliefF', file_name[i], selected_num[i], step[i], 'm', 'KNN')
    #         outResult('SPEC', file_name[i], selected_num[i], step[i], 'm', 'KNN')
    #     except:
    #         print('this dataset arise error')
    #         continue
