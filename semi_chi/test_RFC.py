...
if __name__ == '__main__':
    ...
    for i in range(len(file_name)):
        try:
            ...
            outResult('SEMIFS_MM', file_name[i], selected_num[i], step[i], 's', 'RFC')
            outResult('CHI', file_name[i], selected_num[i], step[i], 's', 'RFC')
            outResult('f_score', file_name[i], selected_num[i], step[i], 's', 'RFC')
            outResult('fisher', file_name[i], selected_num[i], step[i], 's', 'RFC')
            outResult('IG', file_name[i], selected_num[i], step[i], 's', 'RFC')
            outResult('MCFS', file_name[i], selected_num[i], step[i], 's', 'RFC')
            outResult('reliefF', file_name[i], selected_num[i], step[i], 's', 'RFC')
            outResult('SPEC', file_name[i], selected_num[i], step[i], 's', 'RFC')
        except:
    ...
    #     try:
    #         print('---------**** runing : ', '第 ', i + 1, ' 个数据集 *******---------')
    #         outResult('SEMIFS_MM',file_name[i], selected_num[i], step[i], 'o', 'RFC')
    #         outResult('CHI', file_name[i], selected_num[i], step[i], 'o', 'RFC')
    #         outResult('f_score', file_name[i], selected_num[i], step[i], 'o', 'RFC')
    #         outResult('fisher', file_name[i], selected_num[i], step[i], 'o', 'RFC')
    #         outResult('IG', file_name[i], selected_num[i], step[i], 'o', 'RFC')
    #         outResult('MCFS', file_name[i], selected_num[i], step[i], 'o', 'RFC')
    #         outResult('reliefF', file_name[i], selected_num[i], step[i], 'o', 'RFC')
    #         outResult('SPEC', file_name[i], selected_num[i], step[i], 'o', 'RFC')
    #     except:
    #         print('this dataset arise error')
    #         continue
    #
    ...
    #     try:
    #         print('---------**** runing : ', '第 ', i + 1, ' 个数据集 *******---------')
    #         outResult('SEMIFS_MM',file_name[i], selected_num[i], step[i], 'm', 'RFC')
    #         outResult('CHI', file_name[i], selected_num[i], step[i], 'm', 'RFC')
    #         outResult('f_score', file_name[i], selected_num[i], step[i], 'm', 'RFC')
    #         outResult('fisher', file_name[i], selected_num[i], step[i], 'm', 'RFC')
    #         outResult('IG', file_name[i], selected_num[i], step[i], 'm', 'RFC')
    #         outResult('MCFS', file_name[i], selected_num[i], step[i], 'm', 'RFC')
    #         outResult('reliefF', file_name[i], selected_num[i], step[i], 'm', 'RFC')
    #         outResult('SPEC', file_name[i], selected_num[i], step[i], 'm', 'RFC')
    #     except:
    #         print('this dataset arise error')
    #         continue
