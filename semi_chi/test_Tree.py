...
if __name__ == '__main__':
    ...
    for i in range(len(file_name)):
        try:
            ...
            outResult('SEMIFS_MM', file_name[i], selected_num[i], step[i], 's', 'Tree')
            outResult('CHI', file_name[i], selected_num[i], step[i], 's', 'Tree')
            outResult('f_score', file_name[i], selected_num[i], step[i], 's', 'Tree')
            outResult('fisher', file_name[i], selected_num[i], step[i], 's', 'Tree')
            outResult('IG', file_name[i], selected_num[i], step[i], 's', 'Tree')
            outResult('MCFS', file_name[i], selected_num[i], step[i], 's', 'Tree')
            outResult('reliefF', file_name[i], selected_num[i], step[i], 's', 'Tree')
            outResult('SPEC', file_name[i], selected_num[i], step[i], 's', 'Tree')
        except:
    ...
    #     try:
    #         print('---------**** runing : ', '第 ', i + 1, ' 个数据集 *******---------')
    #         outResult('SEMIFS_MM',file_name[i], selected_num[i], step[i], 'o', 'Tree')
    #         outResult('CHI', file_name[i], selected_num[i], step[i], 'o', 'Tree')
    #         outResult('f_score', file_name[i], selected_num[i], step[i], 'o', 'Tree')
    #         outResult('fisher', file_name[i], selected_num[i], step[i], 'o', 'Tree')
    #         outResult('IG', file_name[i], selected_num[i], step[i], 'o', 'Tree')
    #         outResult('MCFS', file_name[i], selected_num[i], step[i], 'o', 'Tree')
    #         outResult('reliefF', file_name[i], selected_num[i], step[i], 'o', 'Tree')
    #         outResult('SPEC', file_name[i], selected_num[i], step[i], 'o', 'Tree')
    #     except:
    #         print('this dataset arise error')
    #         continue
    #
    ...
    #     try:
    #         print('---------**** runing : ', '第 ', i + 1, ' 个数据集 *******---------')
    #         outResult('SEMIFS_MM',file_name[i], selected_num[i], step[i], 'm', 'Tree')
    #         outResult('CHI', file_name[i], selected_num[i], step[i], 'm', 'Tree')
    #         outResult('f_score', file_name[i], selected_num[i], step[i], 'm', 'Tree')
    #         outResult('fisher', file_name[i], selected_num[i], step[i], 'm', 'Tree')
    #         outResult('IG', file_name[i], selected_num[i], step[i], 'm', 'Tree')
    #         outResult('MCFS', file_name[i], selected_num[i], step[i], 'm', 'Tree')
    #         outResult('reliefF', file_name[i], selected_num[i], step[i], 'm', 'Tree')
    #         outResult('SPEC', file_name[i], selected_num[i], step[i], 'm', 'Tree')
    #     except:
    #         print('this dataset arise error')
    #         continue
